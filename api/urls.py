...
urlpatterns = [
    ...
    path('api/v1/utility/placements', get_placements, name='get_placements'),
    path('api/v1/utility/goals', get_goals, name='get_goals'),
    path('api/v1/utility/activities', get_activities, name='get_activities'),
    path(
        'api/v1/utility/ambassador_statuses',
        get_ambassador_statuses,
        name='get_ambassador_statuses',
    ),
    path('api/v1/utility/achivies', get_achivies, name='get_achivies'),
    path(
