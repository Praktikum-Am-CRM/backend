...
class ReportType(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    report_name = models.CharField(max_length=100, verbose_name='Вид задания')
    available = models.BooleanField(default=True)
...
class Report(models.Model):
    ...
    ambassador_id = models.ForeignKey(to=Ambassador, on_delete=models.PROTECT)
    ...
    screen = models.FileField(
        upload_to='reports/screens/', null=True, default=None
    )
    placement_id = models.ForeignKey(to=Placement, on_delete=models.PROTECT)
    ...
    report_type_id = models.ForeignKey(to=ReportType, on_delete=models.PROTECT)
